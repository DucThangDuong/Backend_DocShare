...
*   **Lưu trữ Object (Storage)**: MinIO (Tương thích chuẩn AWS S3) dùng cho lưu tĩnh file PDF và Avatar.
...
*   **Rate Limiting**: Custom policies để giới hạn requests.
*   **Thư viện xử lý Web**: SignalR (Real-time notifications)
...
Tạo file có tên `docker-compose.yml` tại thư mục gốc của dự án `docShare_Backend` với nội dung sau:
