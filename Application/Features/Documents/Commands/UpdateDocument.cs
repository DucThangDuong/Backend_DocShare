...
public class UpdateDocumentHandler : ICommandHandler<UpdateDocumentCommand>
{
    ...
    public UpdateDocumentHandler(IUnitOfWork repo, IStorageService storageService, IRabbitMQService rabbitMQ, IMemoryCache cache)
    {
    ...
    public async Task<Result> HandleAsync(UpdateDocumentCommand cmd, CancellationToken ct = default)
    {
        ...
        if (doc == null) return Result.Failure("TÃ i liá»‡u khÃ´ng tá»“n táº¡i.", 404);
